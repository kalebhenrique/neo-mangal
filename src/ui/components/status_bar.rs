...
impl StatusBarComponent {
    pub fn render(frame: &mut Frame, area: Rect, current_view: &str, output_path: &str, lang: AppLanguage) {
        ...
        let help_style = Style::default().fg(Color::Cyan).add_modifier(Modifier::BOLD);

        let mut spans = match (current_view, lang) {
            // Favorites / Home view
            ("favorites", AppLanguage::English) => vec![
                Span::styled(" [Enter] ", key_style),
                Span::styled("Chapters  ", desc_style),
            ...
            ("favorites", AppLanguage::Portuguese) => vec![
                Span::styled(" [Enter] ", key_style),
                Span::styled("Capítulos  ", desc_style),
                Span::styled(" [/] ", key_style),
                Span::styled("Buscar  ", desc_style),
                Span::styled(" [f] ", key_style),
                Span::styled("Remover  ", desc_style),
                Span::styled(" [?] ", key_style),
                Span::styled("Ajuda", help_style),
            ],

            // Search view (typing in search bar)
            ("search", AppLanguage::English) => vec![
                Span::styled(" [Enter] ", key_style),
                Span::styled("Search  ", desc_style),
                Span::styled(" [Esc] ", key_style),
                Span::styled("Back/Unfocus  ", desc_style),
                Span::styled(" [Ctrl+P] ", key_style),
                Span::styled("Sources  ", desc_style),
            ...
            ("search", AppLanguage::Portuguese) => vec![
                ...
                Span::styled("Buscar  ", desc_style),
                Span::styled(" [Esc] ", key_style),
                Span::styled("Voltar/Desfocar  ", desc_style),
                Span::styled(" [Ctrl+P] ", key_style),
                Span::styled("Fontes  ", desc_style),
                Span::styled(" [F2] ", key_style),
            ...
            ("manga_list", AppLanguage::English) => vec![
                ...
                Span::styled("Chapters  ", desc_style),
                Span::styled(" [f] ", key_style),
                Span::styled("Favorite  ", desc_style),
                Span::styled(" [/] ", key_style),
            ...
            ("manga_list", AppLanguage::Portuguese) => vec![
                ...
                Span::styled("Capítulos  ", desc_style),
                Span::styled(" [f] ", key_style),
                Span::styled("Favoritar  ", desc_style),
                Span::styled(" [/] ", key_style),
            ...
            ("chapter_list", AppLanguage::English) => vec![
                ...
                Span::styled("Mark Read  ", Style::default().fg(Color::LightMagenta).add_modifier(Modifier::BOLD)),
            ...
            ("chapter_list", AppLanguage::Portuguese) => vec![
                ...
                Span::styled(" [m] ", key_style),
                Span::styled("Marcar Lido  ", Style::default().fg(Color::LightMagenta).add_modifier(Modifier::BOLD)),
